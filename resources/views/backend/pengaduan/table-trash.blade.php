<table class="table table-striped">
  ...
  @foreach($pengaduans as $pengaduan)
      ...
      <td align="center" ="center">
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'PUT', 'route' => ['pengaduan.restore', $pengaduan->id]]) !!}
          <button title="Restore" class="btn btn-warning btn-sm btn-block">
              <i class="fa fa-refresh text-black"></i> Restore
          </button>
        {!! Form::close() !!}
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'DELETE', 'route' => ['pengaduan.force-destroy', $pengaduan->id]]) !!}
