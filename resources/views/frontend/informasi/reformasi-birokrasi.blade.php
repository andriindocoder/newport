...
<section>
    ...
    <div class="content-box">
        <div class="container">
            <div class="row">
                <div class="col">
                    <label class="content-label">Reformasi Birokrasi Kantor Otoritas Pelabuhan Tanjung Priok</label>
                </div>
            </div>
                ...
                <div class="col-md-12">
					<table class="table table-striped">
					  <tr>
					    ...
					    <th>Tahun</th>
					    <th>Bulan</th>
					    <th class="text-center" style="width: 200px">Download Reformasi Birokrasi</th>
					  </tr>
                      <?php $no = paging_number($perPage);?>
                        @foreach($kontens as $konten)
					    <tr>
					      <td>{{ $no }}</td>
					      <td><a href="{{ url('info').'/reformasi-birokrasi/'.$konten->slug }}">{{ $konten->judul_informasi }}</a></td>
