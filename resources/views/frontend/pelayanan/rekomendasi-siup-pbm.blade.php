...
@section('pageTitle', 'Pelayanan Rekomendasi Surat Izin Usaha Bongkar Muat')
	...
	<section>
	            ...
	            <div class="row">
	                <div class="col">
	                    <div class="desc">
	                        ...
	                        <h2>Rekomendasi Surat Izin Usaha Bongkar Muat</h2>
	                    </div>
	                </div>
	            </div>
	        </div>
	    ...
	    <div class="content-box">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <label class="content-label">Rekomendasi Surat Izin Usaha Bongkar Muat</label>
                        </div>
                    </div>
	            ...
	            <div class="row">
	                <div class="col">
	                    ...
	                    <div class="contact-form">
                                <label class="contact-label"><span>PMKU Non Inaportnet - Pelayanan Rekomendasi Surat Izin Usaha Bongkar Muat</span></label>
                                    <div class="row">
                                        <div class="col-md-12">
