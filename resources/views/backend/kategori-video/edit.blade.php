...
@section('breadcrumb','Edit Kategori Video')
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Edit Kategori Video</li>
                        </ol>
                        <div class="card border-primary mb-3 card-info">
                        <div class="card-header">Edit Kategori Video</div>
                            <div class="card-body">
                                {!! Form::model($kategoriVideo,[
                                    'url'       => route('admin.kategori-video.update', $kategoriVideo->id),
                                    'method'    => 'put',
