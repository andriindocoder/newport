...
@section('content')
	<section>
	    <div class="content-header">
	        <img src="{{ asset('portal-frontend/images/bg-header3.png') }}" />
	        <div class="container">
	            <div class="row">
	                <div class="col">
	                    <div class="desc">
	                    ...
	                    <div class="contact-form">
	                            ...
	                            <div class="row">
	                                <div class="col-md-6">
										...
										{!! Form::text('npwp', null , ['class'=> 'form-control', 'placeholder' => '' ]) !!}
	                                ...
	                                <div class="col-md-6">
										<div class="form-group {{ $errors->has('nama_perusahaan') ? 'has-error' : ''}} m-input">
											...
											{!! Form::text('nama_perusahaan', Auth::user()->nama_perusahaan, ['class'=> 'form-control', 'placeholder' => Auth::user()->nama_perusahaan, 'disabled'=>'disabled' ]) !!}
										...
										<div class="form-group {{ $errors->has('nomor_siup') ? 'has-error' : ''}} m-input">
											...
											{!! Form::text('nomor_siup', null, ['class'=> 'form-control', 'placeholder' => '']) !!}
