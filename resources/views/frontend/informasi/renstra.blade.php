...
<section>
            ...
            <div class="row">
                <div class="col">
                    <div class="desc">
                        ...
                        <h2>Renstra Kantor OP Tanjung Priok</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content-box">
        <div class="container">
            <div class="row">
                <div class="col">
                    <label class="content-label">Renstra Kantor Otoritas Pelabuhan Tanjung Priok</label>
                </div>
            </div>
                ...
                <div class="col-md-12">
					<table class="table table-striped">
					  <tr>
					    ...
					    <th>Tahun</th>
					    <th>Bulan</th>
					    <th class="text-center" style="width: 200px">Download Renstra</th>
					  </tr>
