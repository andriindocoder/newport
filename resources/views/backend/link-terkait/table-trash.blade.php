<table class="table table-striped">
  ...
  @foreach($linkTerkaits as $linkTerkait)
      ...
      <td align="center" ="center">
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'PUT', 'route' => ['link-terkait.restore', $linkTerkait->id]]) !!}
          <button title="Restore" class="btn btn-warning btn-sm btn-block">
              <i class="fa fa-refresh text-black"></i> Restore
          </button>
        {!! Form::close() !!}
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'DELETE', 'route' => ['link-terkait.force-destroy', $linkTerkait->id]]) !!}
