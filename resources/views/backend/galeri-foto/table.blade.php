<table class="table table-striped">
  ...
  @foreach($galeriFotos as $galeriFoto)
      ...
      <td align="center">
        {!! Form::open(['method' => 'DELETE', 'route' => ['galeri-foto.destroy', $galeriFoto->id]]) !!}
        <a href="{{ route('galeri-foto.edit', $galeriFoto->id) }}" class="btn btn-sm btn-warning btn-block" title="Edit">
