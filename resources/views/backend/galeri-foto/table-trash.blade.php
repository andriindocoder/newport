<table class="table table-striped">
  ...
  @foreach($galeriFotos as $galeriFoto)
      ...
      <td align="center" ="center">
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'PUT', 'route' => ['admin.galeri-foto.restore', $galeriFoto->id]]) !!}
          <button title="Restore" class="btn btn-warning btn-sm btn-block">
              <i class="fa fa-refresh text-black"></i> Restore
          </button>
        {!! Form::close() !!}
        {!! Form::open(['style'=>'display:inline-block;', 'method' => 'DELETE', 'route' => ['admin.galeri-foto.force-destroy', $galeriFoto->id]]) !!}
