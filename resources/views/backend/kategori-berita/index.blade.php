          ...
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                        <p><a href="{{ route('kategori-berita.create') }}" class="btn btn-outline-info"><span><i class="fa fa-plus-circle"></i></span> Tambah Kategori Berita</a></p>
...
<script>
    $(function(){
        $('table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('kategori-berita.data') !!}',
            columns: [
