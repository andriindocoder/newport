...
<section>
            ...
            <div class="row">
                <div class="col">
                    <div class="desc">
                        ...
                        <h2>Indeks Kepuasan Masyarakat Kantor OP Tanjung Priok</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content-box">
        <div class="container">
            <div class="row">
                <div class="col">
                    <label class="content-label">Indeks Kepuasan Masyarakat Kantor Otoritas Pelabuhan Tanjung Priok</label>
                </div>
            </div>
                ...
                <div class="col-md-12">
					<table class="table table-striped">
					  <tr>
					    ...
					    <th>Tahun</th>
					    <th>Bulan</th>
					    <th class="text-center" style="width: 200px">Download IKM</th>
					  </tr>
                      <?php $no = paging_number($perPage);?>
                        @foreach($kontens as $konten)
					    <tr>
					      <td>{{ $no }}</td>
					      <td><a href="{{ url('info').'/indeks-kepuasan-masyarakat/'.$konten->slug }}">{{ $konten->judul_informasi }}</a></td>
